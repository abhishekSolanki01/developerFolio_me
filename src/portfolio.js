...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/10zFoAOfdPNHI6lDND_GjbBx9752ovcTn/view?usp=sharing", // Set to empty to hide the button
...
const skillsSection = {
  ...
  skills: [
    ...
    emoji("⚡ Progressive Web Applications ( PWA ) and Monorepos"),
    emoji(
